...
/* ── Only 3 floating icons: C#, Python, CSS ── */
const LANG_ICONS = [
  {
    id: "python",
    label: "Python",
    ...
    delay: 0,
    size: 44,
    svg: `<rect width="44" height="44" rx="10" fill="#3776AB"/>
          <text x="7" y="29" font-family="monospace" font-size="17" font-weight="900" fill="#FFD43B">Py</text>`,
  },
  {
    id: "csharp",
    label: "C#",
    ...
    delay: 0.5,
    size: 44,
    svg: `<rect width="44" height="44" rx="10" fill="#9B4F96"/>
          <text x="8" y="31" font-family="monospace" font-size="20" font-weight="900" fill="#fff">C#</text>`,
  },
  {
    id: "css",
    label: "CSS3",
    ...
    delay: 0.9,
    size: 44,
    svg: `<rect width="44" height="44" rx="10" fill="#1572B6"/>
          <text x="4" y="30" font-family="monospace" font-size="15" font-weight="900" fill="#fff">CSS3</text>`,
...
<template>
  <section id="hero" ref="sectionRef" class="hero">
    ...
    <!-- Scroll indicator — below the grid, centered -->
...
@media (min-width: 1024px) {
  .hero-inner { grid-template-columns: 5fr 7fr; gap: 5rem; }
}
...
@keyframes icon-float {
  ...
  50%       { transform: translateY(-12px); opacity: 0.72; }
}
/* CSS icon centered at bottom */
.lang-icon[title="CSS3"] {
  animation-name: icon-float-center;
}
@keyframes icon-float-center {
  0%, 100% { transform: translateX(-50%) translateY(0px); opacity: 0.92; }
  50%       { transform: translateX(-50%) translateY(-12px); opacity: 0.72; }
}
...
.corner {
  ...
  border-color: var(--primary); border-style: solid; z-index: 10;
  opacity: 0.5;
}
...
.avail-badge {
  ...
  font-size: 0.65rem; font-weight: 500; color: var(--fg-dim);
...
.btn-primary:hover {
  background: var(--primary);
  box-shadow: 0 4px 28px rgba(139,101,32,0.3);
}
